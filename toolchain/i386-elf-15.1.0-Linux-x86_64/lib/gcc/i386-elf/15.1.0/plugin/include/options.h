...
enum opt_code
{
  ...
  OPT_list = 2039,                           /* -list */
  OPT_m128bit_long_double = 2040,            /* -m128bit-long-double */
  OPT_m16 = 2041,                            /* -m16 */
  OPT_m32 = 2042,                            /* -m32 */
  OPT_m3dnow = 2043,                         /* -m3dnow */
  OPT_m3dnowa = 2044,                        /* -m3dnowa */
  OPT_m64 = 2045,                            /* -m64 */
  OPT_m80387 = 2046,                         /* -m80387 */
  OPT_m8bit_idiv = 2047,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 2048,             /* -m96bit-long-double */
  OPT_mabi_ = 2049,                          /* -mabi= */
  OPT_mabm = 2050,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 2051,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 2052,                 /* -maddress-mode= */
  OPT_madx = 2053,                           /* -madx */
  OPT_maes = 2054,                           /* -maes */
  OPT_main = 2055,                           /* -main */
  OPT_main_ = 2056,                          /* -main= */
  OPT_malign_data_ = 2057,                   /* -malign-data= */
  OPT_malign_double = 2058,                  /* -malign-double */
  OPT_malign_functions_ = 2059,              /* -malign-functions= */
  OPT_malign_jumps_ = 2060,                  /* -malign-jumps= */
  OPT_malign_loops_ = 2061,                  /* -malign-loops= */
  OPT_malign_stringops = 2062,               /* -malign-stringops */
  OPT_mamx_avx512 = 2063,                    /* -mamx-avx512 */
  OPT_mamx_bf16 = 2064,                      /* -mamx-bf16 */
  OPT_mamx_complex = 2065,                   /* -mamx-complex */
  OPT_mamx_fp16 = 2066,                      /* -mamx-fp16 */
  OPT_mamx_fp8 = 2067,                       /* -mamx-fp8 */
  OPT_mamx_int8 = 2068,                      /* -mamx-int8 */
  OPT_mamx_movrs = 2069,                     /* -mamx-movrs */
  OPT_mamx_tf32 = 2070,                      /* -mamx-tf32 */
  OPT_mamx_tile = 2071,                      /* -mamx-tile */
  OPT_mamx_transpose = 2072,                 /* -mamx-transpose */
  OPT_mapx_features_ = 2073,                 /* -mapx-features= */
  OPT_mapx_inline_asm_use_gpr32 = 2074,      /* -mapx-inline-asm-use-gpr32 */
  OPT_mapxf = 2075,                          /* -mapxf */
  OPT_march_ = 2076,                         /* -march= */
  OPT_masm_ = 2077,                          /* -masm= */
  OPT_mavx = 2078,                           /* -mavx */
  OPT_mavx10_1 = 2079,                       /* -mavx10.1 */
  OPT_mavx10_1_256 = 2080,                   /* -mavx10.1-256 */
  /* OPT_mavx10_1_512 = 2081, */             /* -mavx10.1-512 */
  OPT_mavx10_2 = 2082,                       /* -mavx10.2 */
  OPT_mavx2 = 2083,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 2084,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 2085,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bf16 = 2086,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 2087,                  /* -mavx512bitalg */
  OPT_mavx512bw = 2088,                      /* -mavx512bw */
  OPT_mavx512cd = 2089,                      /* -mavx512cd */
  OPT_mavx512dq = 2090,                      /* -mavx512dq */
  OPT_mavx512f = 2091,                       /* -mavx512f */
  OPT_mavx512fp16 = 2092,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 2093,                    /* -mavx512ifma */
  OPT_mavx512vbmi = 2094,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 2095,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 2096,                      /* -mavx512vl */
  OPT_mavx512vnni = 2097,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 2098,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 2099,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 2100,                       /* -mavxifma */
  OPT_mavxneconvert = 2101,                  /* -mavxneconvert */
  OPT_mavxvnni = 2102,                       /* -mavxvnni */
  OPT_mavxvnniint16 = 2103,                  /* -mavxvnniint16 */
  OPT_mavxvnniint8 = 2104,                   /* -mavxvnniint8 */
  OPT_mbmi = 2105,                           /* -mbmi */
  OPT_mbmi2 = 2106,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 2107,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 2108,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 2109,                    /* -mcet-switch */
  OPT_mcld = 2110,                           /* -mcld */
  OPT_mcldemote = 2111,                      /* -mcldemote */
  OPT_mclflushopt = 2112,                    /* -mclflushopt */
  OPT_mclwb = 2113,                          /* -mclwb */
  OPT_mclzero = 2114,                        /* -mclzero */
  OPT_mcmodel_ = 2115,                       /* -mcmodel= */
  OPT_mcmpccxadd = 2116,                     /* -mcmpccxadd */
  /* OPT_mcpu_ = 2117, */                    /* -mcpu= */
  OPT_mcrc32 = 2118,                         /* -mcrc32 */
  OPT_mcx16 = 2119,                          /* -mcx16 */
  OPT_mdaz_ftz = 2120,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 2121,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 2122,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 2123,            /* -mdump-tune-features */
  OPT_menqcmd = 2124,                        /* -menqcmd */
  OPT_mevex512 = 2125,                       /* -mevex512 */
  OPT_mf16c = 2126,                          /* -mf16c */
  OPT_mfancy_math_387 = 2127,                /* -mfancy-math-387 */
  OPT_mfentry = 2128,                        /* -mfentry */
  OPT_mfentry_name_ = 2129,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 2130,               /* -mfentry-section= */
  OPT_mfma = 2131,                           /* -mfma */
  OPT_mfma4 = 2132,                          /* -mfma4 */
  OPT_mforce_drap = 2133,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 2134,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 2135,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 2136,                       /* -mfpmath= */
  OPT_mfsgsbase = 2137,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 2138,              /* -mfunction-return= */
  /* OPT_mfused_madd = 2139, */              /* -mfused-madd */
  OPT_mfxsr = 2140,                          /* -mfxsr */
  /* OPT_mgather = 2141, */                  /* -mgather */
  OPT_mgeneral_regs_only = 2142,             /* -mgeneral-regs-only */
  OPT_mgfni = 2143,                          /* -mgfni */
  OPT_mhard_float = 2144,                    /* -mhard-float */
  OPT_mharden_sls_ = 2145,                   /* -mharden-sls= */
  OPT_mhle = 2146,                           /* -mhle */
  OPT_mhreset = 2147,                        /* -mhreset */
  OPT_miamcu = 2148,                         /* -miamcu */
  OPT_mieee_fp = 2149,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 2150,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 2151,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 2152,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 2153,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 2154,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 2155,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 2156,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 2157, */            /* -mintel-syntax */
  OPT_mkl = 2158,                            /* -mkl */
  OPT_mlam_ = 2159,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2160,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2161,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2162,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2163,                /* -mlong-double-80 */
  OPT_mlwp = 2164,                           /* -mlwp */
  OPT_mlzcnt = 2165,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2166,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2167,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2168,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2169,                  /* -mmitigate-rop */
  OPT_mmmx = 2170,                           /* -mmmx */
  OPT_mmovbe = 2171,                         /* -mmovbe */
  OPT_mmovdir64b = 2172,                     /* -mmovdir64b */
  OPT_mmovdiri = 2173,                       /* -mmovdiri */
  OPT_mmove_max_ = 2174,                     /* -mmove-max= */
  OPT_mmovrs = 2175,                         /* -mmovrs */
  OPT_mmpx = 2176,                           /* -mmpx */
  OPT_mms_bitfields = 2177,                  /* -mms-bitfields */
  OPT_mmwait = 2178,                         /* -mmwait */
  OPT_mmwaitx = 2179,                        /* -mmwaitx */
  OPT_mneeded = 2180,                        /* -mneeded */
  OPT_mno_align_stringops = 2181,            /* -mno-align-stringops */
  OPT_mno_default = 2182,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2183,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2184,                  /* -mno-push-args */
  OPT_mno_red_zone = 2185,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2186,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2187,                    /* -mnop-mcount */
  OPT_mnoreturn_no_callee_saved_registers = 2188,/* -mnoreturn-no-callee-saved-registers */
  OPT_momit_leaf_frame_pointer = 2189,       /* -momit-leaf-frame-pointer */
  OPT_mpartial_vector_fp_math = 2190,        /* -mpartial-vector-fp-math */
  OPT_mpc32 = 2191,                          /* -mpc32 */
  OPT_mpc64 = 2192,                          /* -mpc64 */
  OPT_mpc80 = 2193,                          /* -mpc80 */
  OPT_mpclmul = 2194,                        /* -mpclmul */
  OPT_mpcommit = 2195,                       /* -mpcommit */
  OPT_mpconfig = 2196,                       /* -mpconfig */
  OPT_mpku = 2197,                           /* -mpku */
  OPT_mpopcnt = 2198,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2199, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2200,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2201,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2202,                     /* -mprefetchi */
  OPT_mprfchw = 2203,                        /* -mprfchw */
  OPT_mptwrite = 2204,                       /* -mptwrite */
  OPT_mpush_args = 2205,                     /* -mpush-args */
  OPT_mraoint = 2206,                        /* -mraoint */
  OPT_mrdpid = 2207,                         /* -mrdpid */
  OPT_mrdrnd = 2208,                         /* -mrdrnd */
  OPT_mrdseed = 2209,                        /* -mrdseed */
  OPT_mrecip = 2210,                         /* -mrecip */
  OPT_mrecip_ = 2211,                        /* -mrecip= */
  OPT_mrecord_mcount = 2212,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2213,                 /* -mrecord-return */
  OPT_mred_zone = 2214,                      /* -mred-zone */
  OPT_mregparm_ = 2215,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2216,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2217,                           /* -mrtd */
  OPT_mrtm = 2218,                           /* -mrtm */
  OPT_msahf = 2219,                          /* -msahf */
  /* OPT_mscatter = 2220, */                 /* -mscatter */
  OPT_mserialize = 2221,                     /* -mserialize */
  OPT_msgx = 2222,                           /* -msgx */
  OPT_msha = 2223,                           /* -msha */
  OPT_msha512 = 2224,                        /* -msha512 */
  OPT_mshstk = 2225,                         /* -mshstk */
  OPT_mskip_rax_setup = 2226,                /* -mskip-rax-setup */
  OPT_msm3 = 2227,                           /* -msm3 */
  OPT_msm4 = 2228,                           /* -msm4 */
  OPT_msoft_float = 2229,                    /* -msoft-float */
  OPT_msse = 2230,                           /* -msse */
  OPT_msse2 = 2231,                          /* -msse2 */
  OPT_msse2avx = 2232,                       /* -msse2avx */
  OPT_msse3 = 2233,                          /* -msse3 */
  OPT_msse4 = 2234,                          /* -msse4 */
  OPT_msse4_1 = 2235,                        /* -msse4.1 */
  OPT_msse4_2 = 2236,                        /* -msse4.2 */
  OPT_msse4a = 2237,                         /* -msse4a */
  /* OPT_msse5 = 2238, */                    /* -msse5 */
  OPT_msseregparm = 2239,                    /* -msseregparm */
  OPT_mssse3 = 2240,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2241,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2242, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2243,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2244, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2245,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2246,                  /* -mstackrealign */
  OPT_mstore_max_ = 2247,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2248,            /* -mstringop-strategy= */
  OPT_mstv = 2249,                           /* -mstv */
  OPT_mtbm = 2250,                           /* -mtbm */
  OPT_mtls_dialect_ = 2251,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2252,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2253,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2254,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2255,                         /* -mtune= */
  OPT_muintr = 2256,                         /* -muintr */
  OPT_munroll_only_small_loops = 2257,       /* -munroll-only-small-loops */
  OPT_musermsr = 2258,                       /* -musermsr */
  OPT_mvaes = 2259,                          /* -mvaes */
  OPT_mveclibabi_ = 2260,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2261,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2262,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2263,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2264,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2265,                      /* -mwbnoinvd */
  OPT_mwidekl = 2266,                        /* -mwidekl */
  OPT_mx32 = 2267,                           /* -mx32 */
  OPT_mxop = 2268,                           /* -mxop */
  OPT_mxsave = 2269,                         /* -mxsave */
  OPT_mxsavec = 2270,                        /* -mxsavec */
  OPT_mxsaveopt = 2271,                      /* -mxsaveopt */
  OPT_mxsaves = 2272,                        /* -mxsaves */
  OPT_n = 2273,                              /* -n */
  OPT_name_sort = 2274,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2275,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2276,              /* -no-integrated-cpp */
  OPT_no_pie = 2277,                         /* -no-pie */
  OPT_nocpp = 2278,                          /* -nocpp */
  OPT_nodefaultlibs = 2279,                  /* -nodefaultlibs */
  OPT_nolibc = 2280,                         /* -nolibc */
  OPT_nomain = 2281,                         /* -nomain */
  OPT_nophoboslib = 2282,                    /* -nophoboslib */
  OPT_nostartfiles = 2283,                   /* -nostartfiles */
  OPT_nostdinc = 2284,                       /* -nostdinc */
  OPT_nostdinc__ = 2285,                     /* -nostdinc++ */
  OPT_nostdlib = 2286,                       /* -nostdlib */
  OPT_nostdlib__ = 2287,                     /* -nostdlib++ */
  OPT_o = 2288,                              /* -o */
  OPT_objects = 2289,                        /* -objects */
  OPT_p = 2290,                              /* -p */
  OPT_pass_exit_codes = 2291,                /* -pass-exit-codes */
  /* OPT_pedantic = 2292, */                 /* -pedantic */
  OPT_pedantic_errors = 2293,                /* -pedantic-errors */
  OPT_pg = 2294,                             /* -pg */
  OPT_pie = 2295,                            /* -pie */
  OPT_pipe = 2296,                           /* -pipe */
  OPT_preprocess = 2297,                     /* -preprocess */
  OPT_print_file_name_ = 2298,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2299,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2300,          /* -print-multi-directory */
  OPT_print_multi_lib = 2301,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2302,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2303,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2304,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2305,               /* -print-prog-name= */
  OPT_print_search_dirs = 2306,              /* -print-search-dirs */
  OPT_print_sysroot = 2307,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2308,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2309,                    /* -print-value */
  OPT_quiet = 2310,                          /* -quiet */
  OPT_r = 2311,                              /* -r */
  OPT_remap = 2312,                          /* -remap */
  OPT_reverse_sort = 2313,                   /* -reverse-sort */
  OPT_s = 2314,                              /* -s */
  OPT_save_temps = 2315,                     /* -save-temps */
  OPT_save_temps_ = 2316,                    /* -save-temps= */
  OPT_shared = 2317,                         /* -shared */
  OPT_shared_libgcc = 2318,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2319,               /* -shared-libphobos */
  OPT_size_sort = 2320,                      /* -size-sort */
  /* OPT_specs = 2321, */                    /* -specs */
  OPT_specs_ = 2322,                         /* -specs= */
  OPT_static = 2323,                         /* -static */
  OPT_static_libasan = 2324,                 /* -static-libasan */
  OPT_static_libgcc = 2325,                  /* -static-libgcc */
  OPT_static_libgcobol = 2326,               /* -static-libgcobol */
  OPT_static_libgfortran = 2327,             /* -static-libgfortran */
  OPT_static_libgm2 = 2328,                  /* -static-libgm2 */
  OPT_static_libgo = 2329,                   /* -static-libgo */
  OPT_static_libhwasan = 2330,               /* -static-libhwasan */
  OPT_static_liblsan = 2331,                 /* -static-liblsan */
  OPT_static_libmpx = 2332,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2333,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2334,               /* -static-libphobos */
  OPT_static_libquadmath = 2335,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2336,               /* -static-libstdc++ */
  OPT_static_libtsan = 2337,                 /* -static-libtsan */
  OPT_static_libubsan = 2338,                /* -static-libubsan */
  OPT_static_pie = 2339,                     /* -static-pie */
  /* OPT_std_c__03 = 2340, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2341, */                /* -std=c++0x */
  OPT_std_c__11 = 2342,                      /* -std=c++11 */
  OPT_std_c__14 = 2343,                      /* -std=c++14 */
  OPT_std_c__17 = 2344,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2345, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2346, */                /* -std=c++1z */
  OPT_std_c__20 = 2347,                      /* -std=c++20 */
  OPT_std_c__23 = 2348,                      /* -std=c++23 */
  OPT_std_c__26 = 2349,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2350, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2351, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2352, */                /* -std=c++2c */
  OPT_std_c__98 = 2353,                      /* -std=c++98 */
  OPT_std_c11 = 2354,                        /* -std=c11 */
  OPT_std_c17 = 2355,                        /* -std=c17 */
  /* OPT_std_c18 = 2356, */                  /* -std=c18 */
  /* OPT_std_c1x = 2357, */                  /* -std=c1x */
  OPT_std_c23 = 2358,                        /* -std=c23 */
  /* OPT_std_c2x = 2359, */                  /* -std=c2x */
  OPT_std_c2y = 2360,                        /* -std=c2y */
  /* OPT_std_c89 = 2361, */                  /* -std=c89 */
  OPT_std_c90 = 2362,                        /* -std=c90 */
  OPT_std_c99 = 2363,                        /* -std=c99 */
  /* OPT_std_c9x = 2364, */                  /* -std=c9x */
  OPT_std_f2003 = 2365,                      /* -std=f2003 */
  OPT_std_f2008 = 2366,                      /* -std=f2008 */
  OPT_std_f2008ts = 2367,                    /* -std=f2008ts */
  OPT_std_f2018 = 2368,                      /* -std=f2018 */
  OPT_std_f2023 = 2369,                      /* -std=f2023 */
  OPT_std_f202y = 2370,                      /* -std=f202y */
  OPT_std_f95 = 2371,                        /* -std=f95 */
  OPT_std_gnu = 2372,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2373, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2374, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2375,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2376,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2377,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2378, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2379, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2380,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2381,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2382,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2383, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2384, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2385, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2386,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2387,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2388,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2389, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2390, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2391,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2392, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2393,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2394, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2395,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2396,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2397, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2398, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2399,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2400, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2401, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2402, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2403, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2404, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2405, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2406,                     /* -std=legacy */
  OPT_stdlib_ = 2407,                        /* -stdlib= */
  OPT_symbol_ = 2408,                        /* -symbol= */
  OPT_symbolic = 2409,                       /* -symbolic */
  OPT_t = 2410,                              /* -t */
  OPT_time = 2411,                           /* -time */
  OPT_time_ = 2412,                          /* -time= */
  OPT_traditional = 2413,                    /* -traditional */
  OPT_traditional_cpp = 2414,                /* -traditional-cpp */
  OPT_tree_stats = 2415,                     /* -tree-stats */
  OPT_trigraphs = 2416,                      /* -trigraphs */
  OPT_truncate = 2417,                       /* -truncate */
  OPT_type_stats = 2418,                     /* -type-stats */
  OPT_u = 2419,                              /* -u */
  OPT_undef = 2420,                          /* -undef */
  OPT_v = 2421,                              /* -v */
  OPT_version = 2422,                        /* -version */
  OPT_w = 2423,                              /* -w */
  OPT_wrapper = 2424,                        /* -wrapper */
  OPT_x = 2425,                              /* -x */
  OPT_z = 2426,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
